...
<body style="background: rgba(0, 0, 0, 0.5) url('admin_image/blood-cells.jpg') no-repeat center center fixed; background-size: cover;">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6">
          <h1 class="mt-4 mb-3" style="color:#000000; font-weight: bold; text-align: center;">
      ...
      <div class="card" style="height:0px; background-image:url('admin_image/glossy1.jpg');">
          <div class="card-body">
